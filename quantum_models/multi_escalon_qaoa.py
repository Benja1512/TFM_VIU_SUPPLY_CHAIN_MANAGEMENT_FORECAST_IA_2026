...
csv_path = os.path.join(results_dir, "qaoa_vs_classic.csv")
...
img1 = os.path.join(results_dir, "qaoa_vs_classic.png")
plt.savefig(img1)
...
plt.title("Comparación de variables por método")
plt.legend()
plt.grid(axis='y', linestyle='--', alpha=0.5)
plt.tight_layout()

img2 = os.path.join(results_dir, "comparacion_variables.png")
plt.savefig(img2)
plt.show()  # ✅ Mostrar en otra ventana
